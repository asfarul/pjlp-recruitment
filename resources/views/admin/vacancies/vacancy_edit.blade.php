...
@section('content-header')
    <div class="header-section">
        <h1>
            ...
            <small>Ubah Lowongan Pekerjaan</small>
        </h1>
    </div>
@endsection
            ...
            <div class="block full">
                ...
                <div class='form-group'>
                    <div class="input-group input-daterange" data-date-format="dd/mm/yyyy">
                        {{ Form::text('start_date', date('d/m/Y', strtotime($vacancy->start_date)), array('class' => 'form-control text-center', 'autocomplete' => 'off', 'placeholder' => 'Dari')) }}
